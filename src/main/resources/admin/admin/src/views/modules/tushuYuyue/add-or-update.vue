    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='tushu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="出版时间" prop="chubanTime">
                        <el-input v-model="tushuForm.chubanTime"
                                  placeholder="出版时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="出版时间" prop="chubanTime">
                            <el-input v-model="ruleForm.chubanTime"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="tushuYuyueText">
                        <el-input type="textarea"  :readonly="ro.tushuYuyueText" v-model="ruleForm.tushuYuyueText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tushuYuyueText" label="理由" prop="tushuYuyueText">
                            <span v-html="ruleForm.tushuYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.tushuYuyueYesnoTypes" label="报名状态" prop="tushuYuyueYesnoTypes">
                        <el-input v-model="ruleForm.tushuYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.tushuYuyueYesnoText" label="审核回复" prop="tushuYuyueYesnoText">
                        <span v-html="ruleForm.tushuYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.tushuYuyueShenheTime" label="审核时间" prop="tushuYuyueShenheTime">
                        <span v-html="ruleForm.tushuYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    tushuId: false,
                    yonghuId: false,
                    tushuYuyueText: false,
                    tushuYuyueYesnoTypes: false,
                    tushuYuyueYesnoText: false,
                    tushuYuyueShenheTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    tushuId: '',
                    yonghuId: '',
                    tushuYuyueText: '',
                    tushuYuyueYesnoTypes: '',
                    tushuYuyueYesnoText: '',
                    tushuYuyueShenheTime: '',
                    insertTime: '',
                },
                tushuYuyueYesnoTypesOptions : [],
                tushuOptions : [],
                yonghuOptions : [],
                rules: {
                   tushuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tushu_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tushuYuyueYesnoTypesOptions = data.data.list;
                    }
                });
