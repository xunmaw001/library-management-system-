...
var centerMenu = [
    ...
    ,{
        name: '图书归还申请',
        url: '../tushuYuyue/list.html'
    }
    ,{
        name: '阅览室座位预约',
        url: '../yuelanshiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '阅览室',
        url: './pages/yuelanshi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/tushuguanguanlilixitong/admin/dist/index.html#/login";
